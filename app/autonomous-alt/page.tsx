...
import { calculateDistance } from "@/components/autonomous/orientation-container/distance-calculator/functions/calculate-distance";
import { topics } from "@/topics";
import { toast } from "sonner";
import OrientationContainer from "@/components/autonomous/orientation-container/orientation-container";
import { renderToString } from "react-dom/server";
import { getColor } from "@/functions/getColor";
import RoverMarker from "@/components/autonomous/markers/rover-marker";
import MapController from "@/components/dashboard/test-component";
import WaypointContainer from "@/components/way-point-container/way-point-container";
    ...
    getROS().then((ros) => {
      if (ros.isConnected) {
        const angleTopic = new ROSLIB.Topic({
          ros: ros,
          name: topics["alt_yaw"].name,
          messageType: topics["alt_yaw"].messageType,
        });
        const gpsTopic = new ROSLIB.Topic({
          ros: ros,
          name: topics["alt_gps"].name,
          messageType: topics["alt_gps"].messageType,
        });
