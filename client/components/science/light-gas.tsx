...
const LightHumidityGraph = ({ lightData, humidityData }: LightHumidityGraphProps) => {
    ...
    <div className="h-full w-full">
      <div className="flex items-center justify-end mb-2">
        <span className='text-xs'>
          Last Values: Light {lightReadings[lightReadings.length-1]} Lux | MQ2 {mq2Readings[mq2Readings.length-1]}V
        </span>
      </div>
