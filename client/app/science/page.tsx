...
const ScienceGraphs = () => {
    const [values, setvalues] = useState<string[]>(['0', '0', '0', '0', '0', '0']);
    useEffect(() => {
        getROS().then((ros) => {
  ...
  return (
    ...
    {/* <NPKGraph/> */}
        ...
        <ConcUV concData={values[values.length-1]} uvData={values[values.length-2]}/>
        <PressureAlt data1={values[values.length-4]} data2={values[values.length-3]}/>
