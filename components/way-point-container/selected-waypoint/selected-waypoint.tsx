  ...
  const editWaypoint = () => {
    props.setWaypoints(
      props.waypoints.map((wp) =>
        wp.id === props.selectedWaypoint.id ? props.selectedWaypoint : wp,
      ),
    );
    props.setSelectedWaypoint(null);
  };
  ...
  return (
    <Card className="p-2">
      <div className="flex items-center gap-2">
        <button
          onClick={() => props.setSelectedWaypoint(null)}
      ...
      <div className="flex items-center gap-2 mt-1 justify-between">
        <div className="flex items-center gap-2">
          <div
            className={`h-[12px] w-[12px] ${props.selectedWaypoint.color}`}
          ></div>
              ...
              <DialogHeader>
                ...
                <DialogDescription>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        navigator.clipboard.writeText(
                          `${props.selectedWaypoint.lat}, ${props.selectedWaypoint.lng}`,
                        );
                        toast({
                          title: "Copied",
                  ...
                  <div className="flex items-center gap-2">
                    <div>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger>
                          <div
                            className={`h-[30px] mt-1 w-[30px] rounded-sm ${props.selectedWaypoint.color}`}
                          ></div>
                        </DropdownMenuTrigger>
                          ...
                          >
                            {Object.entries(Colors).map(([key, value]) => (
                              <DropdownMenuRadioItem
                                value={value}
                                key={key}
                                className={`h-[20px] rounded-sm w-[20px] ${value}`}
                              ></DropdownMenuRadioItem>
                            ))}
                          </DropdownMenuRadioGroup>
                        </DropdownMenuContent>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={props.selectedWaypoint.lat}
                        onChange={(e) => {
                          props.setSelectedWaypoint({
                    ...
                    <div>
                      ...
                      <Input
                        type="text"
                        className="w-full mt-1 p-1 border border-gray-300"
                        value={props.selectedWaypoint.lng}
                        onChange={(e) => {
                          props.setSelectedWaypoint({
                            ...props.selectedWaypoint,
                  ...
                  <Button
                    ...
                    disabled={
                      Number.isNaN(props.selectedWaypoint.lat) ||
                      Number.isNaN(props.selectedWaypoint.lng)
                    }
                    className="text-xs mt-1 w-full text-white"
                    size="sm"
                  >
                    Save
                  </Button>
                ...
                <DialogDescription>
                  ...
                  <div className="flex items-center justify-end mt-3">
                    <Button
                      ...
                      size="sm"
                      onClick={() => deleteWaypoint(props.selectedWaypoint)}
                    >
